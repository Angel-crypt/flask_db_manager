...
@content_bp.route("/content/<int:content_id>/genres", methods=["POST"])
@admin_required
...
@content_bp.route("/content/<int:content_id>/genres/<int:genre_id>", methods=["DELETE"])
@admin_required
...
@content_bp.route("/content/<int:content_id>/tags", methods=["POST"])
@admin_required
...
@content_bp.route("/content/<int:content_id>/tags/<int:tag_id>", methods=["DELETE"])
@admin_required
...
@content_bp.route("/content/<int:content_id>/directors", methods=["POST"])
@admin_required
...
@content_bp.route("/content/<int:content_id>/directors/<int:director_id>", methods=["DELETE"])
@admin_required
